...
"""
# Some of the block implementations are referenced from github.com:rwightman/pytorch-image-models

class StandardConv2d(nn.Conv2d):

    def __init__(self, in_channels, out_channels, kernel_size, stride=1,
                 padding=0, dilation=1, groups=1, bias=True):
        super(StandardConv2d, self).__init__(in_channels, out_channels, kernel_size, stride,
